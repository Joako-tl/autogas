                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu animate slideIn" data-bs-popper="static">
                                <li>
                                    <a class="dropdown-item" href="/conversionglp"> Conversión a GLP</a>
                                </li>
                                <li>
        ...
        <!-- Masthead-->
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-6">
                        <a><img class="visionmision" src="assets/img/gas-natural.png"/>
                            <h4 class="my-4">¿Qué es GNV?</h4>
                            <p class="text-muted align-col">Gas Natural Vehicular (GNV) se utiliza como combustible para vehículos. Es una de las alternativas al gasolina o diésel tradicional.</p>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6">
                        <a ><img class="visionmision" src="assets/img/ventaja.png"/>
                            <h4 class="my-4">Ventajas de la conversión a GNV</h4>
                            <p class="text-muted align-col">El GNV es 55% más barato que el GLP y 70% más barato que la gasolina. Además, reduce los gastos de mantenimiento de tu motor.</p>
                            <a href="#ventajasgnv">Conoce más sobre las ventajas</a>
                        </a>    
                    </div>
                </div>
            </div>
